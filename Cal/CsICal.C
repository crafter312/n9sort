void CsICal()
{
  ...
  //TFile* file = new TFile("/mnt/analysis/e25001/rootout/sort_cal_a_Al0-25.root");
	//TFile* file = new TFile("/data4/N9/mnt/analysis/e25001/rootout/sort_cal_a_nothing_angleDep.root");
  TFile* file = new TFile("/data4/N9/mnt/analysis/e25001/rootout/sort_cal_a_Al0-25_angleDep.root");
  ...
  //ofstream ofile("/user/e25001/analysis/n9sort/CsI_a_Al0-25.dat");
	//ofstream ofile("/home/Li6Webb/Desktop/9N/n9sort/Cal/CsI_a_nothing_angleDep.dat");
  ofstream ofile("/home/Li6Webb/Desktop/9N/n9sort/Cal/CsI_a_Al0-25_angleDep.dat");
  ...
  int p1= 5, p2=50; //+- fit limits up to 2 peaks. May be different. (p1 30 for no background fit, p1 5 for with linear background)
  ...
  for(int it=0;it<4;it++)
    ...
    for (int ic=0;ic<7;ic++) {
      ...
      if (it == 0 && ic == 5)
        outstring << "Summary/1dCsI_Energy/CsI_Energy_pcal_" << it << "_" << ic;
      else
        outstring << "Summary/1dCsI_Energy/CsI_Energy_pcal_center_" << it << "_" << ic;
      name = outstring.str();
...
//      hist->Rebin(2);
			//hist->GetXaxis()->SetRangeUser(200,300); // for alpha with no degrader
      hist->GetXaxis()->SetRangeUser(125,225); // for alpha with 1/4 inch Al degrader
     ...
     // TF1 *l1 = new TF1("l1", "pol1", bkg_lo, bkg_hi);
      ...
      //TF1 *total = new TF1("total", "gaus(0)", peak1_lo,peak1_hi); // [0] is Gaus scaling, [1] is Gaus mean, [2] is Gaus sigma
      ...
      /*
      total->SetParameters(0,.8*hist->GetMaximum());
      total->SetParameters(1,peak1);
      total->SetParLimits(1,peak1_lo,peak1_hi);
      total->SetParameters(2,8);
      total->SetParLimits(2,2,12);
      */
      hist->Fit(total,"R+");
